...
public class BeerOrderStateMachineConfig extends StateMachineConfigurerAdapter<BeerOrderStatusEnum, BeerOrderEventEnum> {
    ...
    @Qualifier("validationFailureAction")
    private final Action<BeerOrderStatusEnum, BeerOrderEventEnum> validationFailureAction;
    @Qualifier("allocationFailureAction")
    private final Action<BeerOrderStatusEnum, BeerOrderEventEnum> allocationFailureAction;
    @Qualifier("deallocateOrderAction")
    private final Action<BeerOrderStatusEnum, BeerOrderEventEnum> deallocateOrderAction;

    public BeerOrderStateMachineConfig(Action<BeerOrderStatusEnum, BeerOrderEventEnum> validateOrderAction, Action<BeerOrderStatusEnum, BeerOrderEventEnum> allocateOrderAction, Action<BeerOrderStatusEnum, BeerOrderEventEnum> validationFailureAction, Action<BeerOrderStatusEnum, BeerOrderEventEnum> allocationFailureAction, Action<BeerOrderStatusEnum, BeerOrderEventEnum> deallocateOrderAction) {
